 ...
 * Sends water level readings to Bahaba API
 * 
...
// API Configuration
const char* apiUrl = "https://bahaba-a4a2e-default-rtdb.firebaseio.com/readings.json";
...
void setup() {
  ...
  Serial.println("ESP32 Flood Detection System Started");
}
